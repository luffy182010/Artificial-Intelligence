        ...
        <Card className="w-full animate-fade-up p-6 sm:p-8">
          <div className="mb-8 text-center">
            ...
            <p className="mt-3 leading-7 text-text-secondary">
              {locale === "ar"
                ? "ادخل إلى مساحة الحديث التي بدأت تهدأ."
                : "Step back into the conversations you are helping calm."}
            </p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 text-sm">
              <label className="flex min-h-11 items-center gap-2 text-text-secondary">
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded border-white/20 bg-white/10 accent-[#7F77DD]"
                />
              ...
              <Link
                href="#"
                className="font-bold text-teal-to hover:text-text-primary"
              >
                {locale === "ar"
                  ? "نسيت كلمة المرور؟"
                  : "Forgot password?"}
